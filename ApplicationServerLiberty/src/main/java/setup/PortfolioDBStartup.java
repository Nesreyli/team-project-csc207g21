...
public class PortfolioDBStartup {
    ...
    public static void createUserTable() {
        final String sql = "CREATE TABLE IF NOT EXISTS user_record ("
    ...
    public static void createHoldingsTable() {
        final String sql = "CREATE TABLE IF NOT EXISTS holdings ("
    ...
    public static void createCashTable() {
        final String sql = "CREATE TABLE IF NOT EXISTS cash ("
                + " id integer PRIMARY KEY,"
    ...
    public static void createWatchlistTable() {
        final String sql = "CREATE TABLE IF NOT EXISTS watchlist ("
                + "id INTEGER PRIMARY KEY,"
    ...
    public static void createStocksTable() {
        final String sql = "CREATE TABLE IF NOT EXISTS stocks_list ("
                + " id INTEGER PRIMARY KEY,"
    ...
    public static void addStocks(String stockSymbol, String stockName) {
        final String sql = "INSERT INTO stocks_list(symbol,name) VALUES(?,?)";
    ...
    public static void main(String[] args) throws IOException {
        ...
        final BufferedReader stocksData = new BufferedReader(new FileReader(companyUrl));
        final String headline = stocksData.readLine();
        int line = 0;
        while (line < 200) {
            final String[] company = stocksData.readLine().split(",");
